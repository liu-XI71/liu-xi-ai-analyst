...
运行编号：5bdc69d1e82b65f5ab13e3179fde4944 · 模式：demo · 时间：2026-09-19T09:24:37.144573+00:00

**数据说明：合成演示数据，不代表任何企业真实经营结果。**

处理组精确 D7 留存 34.46%，对照组 27.86%；差异 +6.60 pp，95% 区间 [5.17, 8.03] pp。满足预设条件，建议人工评审灰度。质量、成熟、设计样本、业务效应区间与体验非劣围栏均通过。
...
- 处理组精确 D7 留存 34.46%，对照组 27.86%；差异 +6.60 pp，95% 区间 [5.17, 8.03] pp。（证据：experiment-groups, experiment-registry）
- 负反馈差异 +0.22 pp，非劣评审上界 0.85 pp，预注册容忍界值 1.50 pp。（证据：experiment-groups, experiment-registry）
...
| --- | --- | --- | --- | --- | --- |
| control | 8093 | 8093 | 7286 | 2255 | 332 |
| treatment | 7907 | 7907 | 7095 | 2725 | 342 |
### 预注册样本规划
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 精确 D7 留存 | 27.863586 | 34.463134 | 6.599548 | 23.685207 | 5.165873 | 8.029934 | 0.0 |
| 24h 负反馈 | 4.102311 | 4.325281 | 0.222971 | 5.435248 | -0.400292 | 0.847948 | 0.482692 |
### 实验评审门槛
...
| 分配比例 SRM | 对照:处理=50%:50%；卡方 p≥0.001，期望人数均≥5 | 0.14143745182959083 | True |
| 固定观察窗口成熟 | 全部分配用户已完整观察 D7 与 24h 围栏；入组窗口已结束 | 0 | True |
| 达到设计样本 | 对照≥5196、处理≥5196；由 MDE/功效和围栏共同规划 | 对照 8093 / 处理 7907 | True |
| 主要指标与业务门槛 | D7 差异双侧 95% 区间下界≥1 pp | [5.166, 8.030] pp | True |
| 负反馈非劣围栏 | 负反馈差异单侧 97.5% 上界<1.5 pp | 上界 0.848 pp | True |
...
| --- | --- | --- |
| 对照组 | 27.863585814901764 | 4.102310638823674 |
| 处理组 | 34.46313393195902 | 4.325281396231188 |
...
```
参数：{"experiment_id": "healthy_gain", "start": "2026-08-17", "end": "2026-08-30", "cutoff": "2026-09-07 00:00:00", "config_version": "onboarding-v1"}
...
```json
{
  ...
  "snapshot_sha256": "5bdc69d1e82b65f5ab13e3179fde4944dcd415cf7c50978bcff453d290004226",
