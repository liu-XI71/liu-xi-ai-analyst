...
运行编号：e8cb1975fc0f77063f0db22b78a279b2 · 模式：静态案例 · 时间：2026-09-19T11:09:20.004583+00:00

本次读取已保存结果，未执行新查询或模型调用。

**数据说明：合成演示数据，不代表任何企业真实经营结果。**

实验数据不满足评审前提：采集覆盖完整。人数与原始计数仅供核查，暂停效应结论。
...
| --- | --- | --- | --- | --- | --- |
| control | 7930 | 7930 | 7116 | 2242 | 317 |
| treatment | 8070 | 8070 | 7256 | 2747 | 330 |
### 预注册样本规划
...
| 采集覆盖完整 | 所有分配用户均有完整到数清单，水位与注册快照一致 | 缺清单 160；未完整 0 | False |
| 事件与暴露合同 | 事件有分配来源、版本合法、时间为规范本地秒精度且曝光组不串组 | 孤立事件 0；无效事件 0；无效曝光 0 | True |
| 分配比例 SRM | 对照:处理=50%:50%；卡方 p≥0.001，期望人数均≥5 | 0.26838162729276077 | True |
...
```
参数：{"experiment_id": "data_gap", "start": "2026-08-17", "end": "2026-08-30", "cutoff": "2026-09-07 00:00:00", "config_version": "onboarding-v1"}
...
- evaluate_experiment：数据需修复；采集覆盖完整
...
```json
{
  ...
  "snapshot_sha256": "e8cb1975fc0f77063f0db22b78a279b24115c615d26dc9804dd3303ca262482a",
