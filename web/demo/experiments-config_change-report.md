...
运行编号：a813ea5e24e1499e49dc813167edbdb1 · 模式：demo · 时间：2026-09-19T09:24:37.144573+00:00

**数据说明：合成演示数据，不代表任何企业真实经营结果。**

实验数据不满足评审前提：配置稳定。人数与原始计数仅供核查，暂停效应结论。
...
| --- | --- | --- | --- | --- | --- |
| control | 8035 | 8035 | 7240 | 2274 | 317 |
| treatment | 7965 | 7965 | 7177 | 2672 | 316 |
### 预注册样本规划
...
| --- | --- | --- | --- | --- |
| 2026-08-24 00:00:00 | config_version | onboarding-v1 | onboarding-v2 | 1 |
### 实验评审门槛
...
| 配置稳定 | 同一冻结配置，变更时间规范，无入组或观察期内实质变更 | 版本不符 8023；变更 1；时间无效 0 | False |
| 采集覆盖完整 | 所有分配用户均有完整到数清单，水位与注册快照一致 | 缺清单 0；未完整 0 | True |
| 事件与暴露合同 | 事件有分配来源、版本合法、时间为规范本地秒精度且曝光组不串组 | 孤立事件 0；无效事件 0；无效曝光 0 | True |
| 分配比例 SRM | 对照:处理=50%:50%；卡方 p≥0.001，期望人数均≥5 | 0.5799905038550084 | True |
...
```
参数：{"experiment_id": "config_change"}
...
```
参数：{"experiment_id": "config_change", "start": "2026-08-17", "end": "2026-08-30", "cutoff": "2026-09-07 00:00:00", "config_version": "onboarding-v1"}
...
- evaluate_experiment：数据需修复；配置稳定
...
```json
{
  ...
  "snapshot_sha256": "a813ea5e24e1499e49dc813167edbdb1a28fce34b233e0864900a1e0880c185c",
