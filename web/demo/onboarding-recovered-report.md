...
运行编号：aad127bbb2ad0a2f8bdcd189ba7c9e87 · 模式：静态案例 · 时间：2026-09-19T11:09:20.004583+00:00
...
{
  "status": "passed",
  "as_of": "2026-09-08 12:00:00",
  "watermark": "2026-09-08 00:00:00",
  "watermarks_by_device": {
    "android": "2026-09-08 00:00:00",
    "ios": "2026-09-08 00:00:00",
    "web": "2026-09-08 00:00:00"
  },
...
```json
{
  ...
  "data_as_of": "2026-09-08 12:00:00",
  "watermark": "2026-09-08 00:00:00"
}
```
...
| --- | --- | --- | --- | --- |
| 完整观察窗口 | passed | 2026-09-08 12:00:00 | 2026-09-07 00:00:00 | 快照时间必须覆盖完整自然日或实际注册时间 + 24 小时；不得删除未成熟用户后沿用原请求结论。 |
| 连续数据水位 | passed | 2026-09-08 00:00:00 | 2026-09-07 00:00:00 | 水位为所有相关设备分区已完整到达事件时间的排他上界；缺一日不能跳过。 |
...
```
参数：{"start": "2026-08-24", "end": "2026-08-30", "compare_start": "2026-08-17", "compare_end": "2026-08-23", "as_of": "2026-09-08 12:00:00", "activation_seconds": 60}
...
```
参数：{"start": "2026-08-24", "end": "2026-08-30", "compare_start": "2026-08-17", "compare_end": "2026-08-23", "as_of": "2026-09-08 12:00:00", "activation_seconds": 60, "batch_start": "2026-06-01", "batch_end": "2026-09-07", "quality_device_0": "android", "quality_device_1": "ios", "quality_device_2": "web"}
...
```
参数：{"start": "2026-08-24", "end": "2026-08-30", "compare_start": "2026-08-17", "compare_end": "2026-08-23", "as_of": "2026-09-08 12:00:00", "activation_seconds": 60, "batch_start": "2026-06-01", "batch_end": "2026-09-07", "quality_device_0": "android", "quality_device_1": "ios", "quality_device_2": "web", "relevant_start": "2026-08-17", "relevant_end": "2026-09-06", "schema_0": "1.0"}
...
```
参数：{"start": "2026-08-24", "end": "2026-08-30", "compare_start": "2026-08-17", "compare_end": "2026-08-23", "as_of": "2026-09-08 12:00:00", "activation_seconds": 60, "active_event_0": "app_active", "active_event_1": "content_consumed"}
...
```json
{
  ...
  "snapshot_sha256": "aad127bbb2ad0a2f8bdcd189ba7c9e87bf7a58439912d2d18e28951eb0586d38",
