...
运行编号：bafb024446651ad532161b778dae4364 · 模式：demo · 时间：2026-09-19T09:24:37.144573+00:00

**数据说明：合成演示数据，不代表任何企业真实经营结果。**

处理组精确 D7 留存 33.33%，对照组 27.98%；差异 +5.35 pp，95% 区间 [3.92, 6.78] pp。建议停止或调整。负反馈恶化已超过预设界值。
...
- 建议停止或调整：复查体验机制和受影响人群，调整方案后另登记实验；不进入放量。（证据：experiment-registry, experiment-quality, experiment-changes, experiment-groups）
...
- evaluate_experiment：建议停止或调整；负反馈恶化已超过预设界值。
