...
运行编号：bafb024446651ad532161b778dae4364 · 模式：静态案例 · 时间：2026-09-19T11:09:20.004583+00:00

本次读取已保存结果，未执行新查询或模型调用。

**数据说明：合成演示数据，不代表任何企业真实经营结果。**

处理组精确 D7 留存 33.33%，对照组 27.98%；差异 +5.35 pp，95% 区间 [3.92, 6.78] pp。停止或调整，暂停放量。负反馈恶化已超过预设界值。
...
- 处理组精确 D7 留存 33.33%，对照组 27.98%；差异 +5.35 pp，95% 区间 [3.92, 6.78] pp。（证据：experiment-groups, experiment-registry）
- 负反馈差异 +4.49 pp，非劣评审上界 5.26 pp，预注册容忍界值 1.50 pp。（证据：experiment-groups, experiment-registry）
...
- 停止或调整，暂停放量：复查体验机制和受影响人群，调整方案后另登记实验；不进入放量。（证据：experiment-registry, experiment-quality, experiment-changes, experiment-groups）
...
| --- | --- | --- | --- | --- | --- |
| control | 8163 | 8163 | 7330 | 2284 | 346 |
| treatment | 7837 | 7837 | 7044 | 2612 | 684 |
### 预注册样本规划
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 精确 D7 留存 | 27.979909 | 33.32908 | 5.349171 | 19.117898 | 3.920888 | 6.775264 | 0.0 |
| 24h 负反馈 | 4.238638 | 8.72783 | 4.489192 | 105.911192 | 3.729913 | 5.256912 | 0.0 |
### 实验评审门槛
...
| 分配比例 SRM | 对照:处理=50%:50%；卡方 p≥0.001，期望人数均≥5 | 0.009958807962165991 | True |
| 固定观察窗口成熟 | 全部分配用户已完整观察 D7 与 24h 围栏；入组窗口已结束 | 0 | True |
| 达到设计样本 | 对照≥5196、处理≥5196；由 MDE/功效和围栏共同规划 | 对照 8163 / 处理 7837 | True |
| 主要指标与业务门槛 | D7 差异双侧 95% 区间下界≥1 pp | [3.921, 6.775] pp | True |
| 负反馈非劣围栏 | 负反馈差异单侧 97.5% 上界<1.5 pp | 上界 5.257 pp | False |
...
| --- | --- | --- |
| 对照组 | 27.979909347053777 | 4.238637755727061 |
| 处理组 | 33.329080005104 | 8.727829526604568 |
...
```
参数：{"experiment_id": "guardrail", "start": "2026-08-17", "end": "2026-08-30", "cutoff": "2026-09-07 00:00:00", "config_version": "onboarding-v1"}
...
- evaluate_experiment：停止或调整，暂停放量；负反馈恶化已超过预设界值。
...
```json
{
  ...
  "snapshot_sha256": "bafb024446651ad532161b778dae43646fbd641f582e57ffd30b0de62bddb810",
