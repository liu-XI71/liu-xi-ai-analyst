...
Object.assign(labels, {
  previous_successes: '对比期指标达成人数',
  current_successes: '本期指标达成人数',
  delta_pp: '变化（百分点）',
  change_at: '变更时间',
  change_type: '变更类型',
  change_id: '变更标识',
...
const valueLabels={available:'可用',not_available:'不可用',release:'版本发布',acquisition:'获客调整',complete:'完整',partial:'部分已记录',unknown:'未知',not_applicable:'不适用',runtime_error:'运行失败',model_unavailable:'模型不可用',data_quality_blocked:'数据需修复',passed:'通过',failed:'未通过',blocked:'已暂停',invalid_data:'数据无效',waiting_for_maturity:'等待成熟',insufficient_evidence:'证据不足',pending:'尚未执行',recovered:'已恢复',resolved:'已恢复',open:'触发中',demo:'Python 规则分析',live:'模型模式',no_observations:'无使用记录',onboarding:'新用户增长',experiments:'实验评审',repurchase:'复购运营',growth:'原增长域',paid_search:'付费搜索',social:'社交渠道',current:'本期',previous:'对比期',control:'对照组',treatment:'处理组',holdout:'留出组',first:'近期单次购买',active:'活跃复购',cooling:'31—60 日未购',dormant:'60 日以上未购',single:'单次购买沉默',completed:'完成',needs_clarification:'需澄清',insufficient_data:'数据不足',paid:'付费渠道',organic:'自然渠道',referral:'推荐渠道',ios:'iOS',android:'Android',web:'网页'};
